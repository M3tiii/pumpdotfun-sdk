...
async function sendTx(connection, tx, payer, signers, priorityFees, commitment = exports.DEFAULT_COMMITMENT, finality = exports.DEFAULT_FINALITY, blockHash, skipPreflight = true) {
    ...
    newTx.add(tx);
    let versionedTx = await (0, exports.buildVersionedTx)(connection, payer, newTx, commitment, blockHash);
...
const buildVersionedTx = async (connection, payer, tx, commitment = exports.DEFAULT_COMMITMENT, blockHash // speed up if already given
) => {
    if (!blockHash) {
